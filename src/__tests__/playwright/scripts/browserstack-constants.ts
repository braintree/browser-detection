...
// Falls back to a generated value if not set
...
// Use require instead of import to ensure singleton behavior
// eslint-disable-next-line @typescript-eslint/no-require-imports
import BrowserStackLocal from "browserstack-local";

// Shared BrowserStack Local instance - must be the same instance for start/stop
export const bsLocal = new BrowserStackLocal.Local();

// WebSocket endpoint builder for BrowserStack CDP connection
...
// Arguments for starting BrowserStack Local
